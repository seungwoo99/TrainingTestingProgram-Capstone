...
def handle_get_questions():
    try:
        ...
        if test_type == 'manual':
            ...
            logging.debug(
                f"Filter parameters: blooms_taxonomy: {blooms_taxonomy}, subjects: {subjects}, topics: {topics}, question_types: {question_types}, question_difficulties: {question_difficulties}, question_max_points: {question_max_points}")
        else:
        ...
        questions_pool = get_questions(blooms_taxonomy, subjects, topics, question_types, question_difficulties,
                                       training_level_conditions, question_max_points)
